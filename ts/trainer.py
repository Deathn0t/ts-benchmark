...
class TrainerRegressorTrainValid:
    def __init__(self, config, model):
        ...
        self.config_hp = self.config['hyperparameters']
        self.optimizer_name = self.config_hp['optimizer']
        self.loss_metric_name = self.config_hp['loss_metric']
        self.metrics_name = self.config_hp['metrics']
        self.batch_size = self.config_hp['batch_size']
        self.learning_rate = self.config_hp['learning_rate']
        self.num_epochs = self.config_hp['num_epochs']
